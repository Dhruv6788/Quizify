        ...
        <>
            <div className="main w-full font-[g-medium]">
                ...
                <div className="greet mt-5">
                    <p className='font-[g-medium] text-3xl tracking-wide text-center text-black'>Trouble logging in?</p>
                    <p className='text-sm px-7 text-center font-[g-light] mt-2 text-gray-500'>Enter your email and we'll send you a link to get back into your account.</p>
                </div>
                <div className="form-wrapper lg:flex lg:justify-center">
                    <div className="form-container mt-7 px-3 lg:w-[30vw]">
                        ...
                        <div className="flex justify-center mt-5">
                            <p className='capitalize font-[g-medium] text-black'>Back to login? <Link to="/login" className='underline capitalize text-purple-300'>log in</Link></p>
                        </div>
                    </div>
                </div>
            </div>
