...
const LoginForm = () => {
    ...
    return (
        <>
            <div className="main w-full font-[g-medium] lg:mt-24">
                <ToastContainer />
                <Header />
                <div className="greet mt-5">
                    <p className='font-[g-medium] text-3xl tracking-wide text-center text-black'>Sign In To Quizify</p>
                </div>
                    ...
                    <div className="form-container mt-7 px-3 lg:w-[30vw]">
                        <form onSubmit={handleSubmit} method='post'>
                            ...
                            <div className="fp flex justify-end mt-2 font-[g-light]">
                                <Link to="/forgot" className='mr-1 text-black text-sm'>Forgot Password ?</Link>
                            </div>
                        ...
                        <div className="flex justify-center mt-5 text-[#ffffffc6]">
                            <p className='capitalize text-black'>New to Quizify? <Link to="/signup" className='underline capitalize text-purple-400'>Join now</Link></p>
                        </div>
                    </div>
                </div>
            </div>
