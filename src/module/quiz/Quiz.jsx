...
const Quiz = () => {
  ...
  const handleDelete = () => {
    ...
    // For demonstration, let's just navigate to the home page after deletion
    navigateTo('/');
  };
        ...
        <div>
          <div className='text-black'>
            <div className='w-full h-[6vh] bg-slate-700 flex items-center px-3 py-3'>
              <h2 className='text-2xl text-green-300 font-[g-bold] tracking-wider'>{quiz.title}</h2>
            </div>
            <div className='grid grid-cols-2 gap-10 mt-8 px-3'>
              {localStorage.getItem('role') === 'Student' ? (
                <div onClick={() => navigateTo(`/${subject_code}/${quiz_slug}/startquiz`)} className='flex flex-col justify-center items-center border-2 p-3 hover:bg-slate-700 hover:text-white rounded-xl'>
              ...
              {localStorage.getItem('role') !== 'Student' && (
                <div onClick={() => navigateTo(`/${subject_code}/${quiz_slug}/questions`)} className='flex flex-col justify-center items-center border-2 p-3 hover:bg-slate-700 hover:text-white rounded-xl'>
                  <div className='h-[70%] flex justify-center'>
              ...
              <div onClick={() => navigateTo(`/${subject_code}/${quiz_slug}/result`)} className='flex flex-col justify-center items-center border-2 p-3 hover:bg-slate-700 hover:text-white rounded-xl'>
                <div className='h-[70%] flex justify-center'>
              ...
              {localStorage.getItem('role') !== 'Student' && (
                <div onClick={() => navigateTo(`/${subject_code}/${quiz_slug}/edit`)} className='flex flex-col justify-center items-center border-2 p-3 rounded-xl hover:bg-slate-700 hover:text-white'>
                  <div className='h-[70%] flex justify-center'>
              ...
              {localStorage.getItem('role') !== 'Student' && (
                <div className='flex flex-col justify-center items-center border-2 p-3 rounded-xl hover:bg-slate-700 hover:text-white'>
                  <div className='h-[70%] flex justify-center'>
                    <img src={deletebtn} className='w-[100%]' alt='' onClick={() => setShowDeleteConfirmation(true)} />
                  </div>
              ...
              <div className='bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4'>
                <div className='sm:flex sm:items-start'>
                  ...
                  <div className='mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left'>
                    <h3 className='text-lg leading-6 font-medium text-gray-900'>Delete Quiz</h3>
                    <div className='mt-2'>
                      <p className='text-sm text-gray-500'>Are you sure you want to delete this quiz? This action cannot be undone.</p>
                    </div>
                  </div>
                </div>
              </div>
