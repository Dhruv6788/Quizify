...
const AddQuiz = () => {
    ...
    return (
        <>
            ...
            <main className='px-3'>
                <h1 className='text-2xl font-[g-bold] text-green-600'>Data Structures</h1>
                <h2 className='text-lg text= text-green-600 uppercase tracking-widest font-[g-bold]'>New Quiz</h2>
            </main>
